...
- **Кто взял:** Полат (весь код) | Юсуф (SEO/контент) | Азим (анализ/бизнес)
...
> **Реорганизация 27.07.2026:** весь коддинг (включая web-buyer/web-seller backend и landing) теперь у Полата.
> Азим больше не кодит — переходит на надзор/анализ команды + академические/бизнес-вопросы проекта.
> SEO/GEO/AIO контент-анализ landing переходит к Юсуфу.

| Участник | Домен | Нельзя трогать |
|---------|-------|----------------|
| Полат | **Весь код**: `apps/api`, `apps/admin`, `packages/db`, `packages/types`, `apps/mobile-buyer`, `apps/mobile-seller`, `apps/web-buyer`, `apps/web-seller`, landing-ветка | — |
...
| Юсуф | Маркетинг, контент, GTM, продажи + SEO/GEO/AIO контент-анализ landing (не кодит) | Весь код |
...
**Маркетинг, GTM, контент, продажи, SEO/GEO/AIO-анализ landing — Юсуф** (с 27.07.2026), Азим участвует как второй.
Полат — вся инженерия без исключений (api/admin/db/types/tma/web-buyer/web-seller/landing + DevOps/биллинг-cron);
...
- Зона: весь код (включая `apps/web-*` и landing) — Полат. Азим и Юсуф не кодят (см. «Реорганизация 27.07.2026» выше).
