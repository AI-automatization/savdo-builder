...
- **Что случилось (живая проверка 03.08.2026, `fetch_page.py` из claude-seo, не догадка):**
  ...
  ```
  Ветка `seo/landing-aeo-geo-2026-07-30` — **6 коммитов впереди `origin/main`**. В ней:
  `lib/guides.ts` (6 гайдов = 3 темы × uz/ru, 23 FAQ-вопроса, 8 таблиц, 2 HowTo),
  `app/sitemap.ts` на ~12 URL, отдельные `/faq` и `/ru/faq`.
