...
- **Статус:** 🟡 14 реальных багов найдено и верифицировано чтением кода (0 фикшено пока — ждёт решения
  по объёму/приоритету), + 1 уже известный инфра-блокер подтверждён живым в проде.
