...
### 2. LEGAL-OFFER-REQUISITES-001 — реквизиты юр.лица
- Решить кто из нас регистрирует ИП на себя через my.gov.uz
- Потом счёт в банке (UZS), потом вписать реквизиты в `/offer.tsx`
