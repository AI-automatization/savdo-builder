...
- **Домен:** Маркетинг / GTM
- **Кто берёт:** Юсуф (lead: аккаунт, публикация, ежедневные stories) + Азим (участие: нативная UZ-вычитка, договорённости с beta-продавцами) + Claude (рендер Reels через Friday)
...
### Шаг 1 — Подготовка (Юсуф + Азим, до старта)
- [ ] Создать аккаунт Instagram `@maxsavdo` (business account) — **Юсуф**
- [ ] Заполнить bio по шаблону из плана (UZ, ссылка → `t.me/maxsavdo_bot`) — **Юсуф**
- [ ] Создать 5 Highlights: 🏪 Doʻkonlar · 📖 Qanday · ⭐ Fikrlar · 🎁 Beta · ✉️ Aloqa — **Юсуф**
- [ ] Нативная вычитка UZ-текстов плана (тон, естественность) — **Азим**
- [ ] Договориться с 2-3 beta-продавцами: согласие на скрины магазинов + цитаты — **Азим + Юсуф**

### Шаг 2 — Производство Reels (Claude рендерит, Юсуф проверяет)
...
### Шаг 3 — Производство каруселей/static (Юсуф, Canva)
- [ ] Шаблон Dark Luxury в Canva (Rich Black фон, Champagne Gold текст, Inter) — **Юсуф**
- [ ] Дни 3, 5, 9, 12, 15, 18, 22, 25, 28 — карусели по плану
- [ ] Дни 2, 6, 10, 13, 17, 20, 24, 27 — static-посты по плану

### Шаг 4 — Публикация (1 пост в день, 10:00 Ташкент) — **Юсуф**
...
### Ежедневно (параллельно с feed) — **Юсуф**
