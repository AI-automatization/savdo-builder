...
- **Порядок работ (согласовано 03.08.2026):** merge `origin/main` в ветку делает **Юсуф**
  (зона `apps/landing` + решение по FAQ), после этого Claude открывает PR и пишет описание.
