...
Expected: Vite dev server starts on http://localhost:5173, shows "maxsavdo TMA — loading..."
    ...
    <AppShell role="BUYER">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-base font-bold" style={{ color: '#A78BFA' }}>maxsavdo</h1>
            {user && (
        ...
        <div className="p-4" style={{ ...glass }}>
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-[11px]" style={{ color: 'rgba(167,139,250,0.80)' }}>maxsavdo.uz/{store.slug}</p>
            </div>
          </div>
          {store.description && (
