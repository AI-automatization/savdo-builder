...
const ru = {
  ...
  'reg.step1': '🏪 Регистрация продавца\n\nШаг 1/4 — Введите ваше <b>полное имя</b>:',
  'reg.step2': '✅ Отлично!\n\nШаг 2/4 — Введите <b>название магазина</b>:',
  'reg.step3': '✅ Название сохранено!\n\nШаг 3/4 — Введите <b>описание магазина</b> (или пропустите):',
  'reg.step4': '📜 Шаг 4/4 — Последний шаг.\n\nОзнакомьтесь с <a href="{url}">условиями использования платформы maxsavdo</a> для продавцов и подтвердите согласие, чтобы создать магазин.',
  'btn.skip': '⏭ Пропустить',
  'btn.acceptTerms': '✅ Принимаю условия',
  'btn.declineTerms': '❌ Отмена',
  'reg.termsDeclined': '❌ Регистрация отменена — без согласия с условиями магазин создать нельзя.\n\nВернуться к регистрации: /start',
...
const uz: Record<BotKey, string> = {
  ...
  'reg.step1': '🏪 Sotuvchi roʻyxatdan oʻtishi\n\n1/4-qadam — <b>Toʻliq ismingizni</b> kiriting:',
  'reg.step2': '✅ Ajoyib!\n\n2/4-qadam — <b>Doʻkon nomini</b> kiriting:',
  'reg.step3': '✅ Nom saqlandi!\n\n3/4-qadam — <b>Doʻkon tavsifini</b> kiriting (yoki oʻtkazib yuboring):',
  'reg.step4': '📜 4/4-qadam — Oxirgi qadam.\n\nDoʻkon yaratish uchun maxsavdo platformasining <a href="{url}">sotuvchilar uchun foydalanish shartlari</a> bilan tanishing va roziligingizni tasdiqlang.',
  'btn.skip': '⏭ Oʻtkazib yuborish',
  'btn.acceptTerms': '✅ Shartlarga roziman',
  'btn.declineTerms': '❌ Bekor qilish',
  'reg.termsDeclined': '❌ Roʻyxatdan oʻtish bekor qilindi — shartlarga rozilik boʻlmasa doʻkon yaratib boʻlmaydi.\n\nQaytadan boshlash: /start',
