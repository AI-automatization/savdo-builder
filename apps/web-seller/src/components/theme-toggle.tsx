...
/**
 * Theme toggle for seller dashboard. Same shape as buyer's toggle to keep UX
 * consistent across apps. Renders a Sun/Moon icon button with an optional
 * popover for explicit Light / Dark / System selection.
 */
